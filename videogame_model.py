...
class VideogameModel(BaseModel):
	...
	img_url: str = Field(required=True, regex=r"^https?:\/\/\S+")
	pegi: str = Field(required=True, regex=r"^\+\d+\b")
	...
	release: str = Field(required=True, regex=r"^(0?[1-9]|[12][0-9]|3[01]) de (enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre) de \d{4}$")
